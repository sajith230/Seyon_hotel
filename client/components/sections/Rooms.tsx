...
export default function Rooms() {
  return (
    <section id="rooms" className="py-16 sm:py-20 lg:py-24 bg-[var(--background)]">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-10">
          {rooms.map((room, i) => (
            <div
              key={room.type}
              className="group bg-white rounded-2xl shadow-lg overflow-hidden hover-lift border border-slate-100 animate-fade-in-up opacity-0"
